...
#   moving to the next.
# Also, for this problem, four lights, one in each
# corner, are stuck on and can't be turned off.
#
...
if __name__ == '__main__':
   ...
   # Add the four corners to the 'on' lights.
   lights_on.add((0, 0))
   lights_on.add((0, max_y - 1))
   lights_on.add((max_x - 1, 0))
   lights_on.add((max_x - 1, max_y - 1))
