...
# house. For this problem, each Elf will stop
# after delivering presents to 50 houses. To make
# up for it, they decide to deliver presents equal
...
if __name__ == '__main__':
   ...
   while not found:
      ...
      for elf in range(1, house + 1):
         # Would the elf even deliver this far?
         if elf * 50 >= house:
            # Would the elf deliver to this house?
            # If so, add the number of presents.
            if (house % elf) == 0:
               presents += (elf * 11)
