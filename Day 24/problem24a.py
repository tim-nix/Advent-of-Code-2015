...
# three groups of exactly the same weight. The
# first group needs as few packages as possible.
# It doesn't matter how many packages are in
# either of the other two groups, so long as all
