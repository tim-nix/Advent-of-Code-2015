...
#
# What is the least amount of gold you can spend
...
if __name__ == '__main__':
   ...
   for w in weapons:
      ...
      p_damage = w[1]
      cost = w[0]
      if isWin(e_attr, (p_hp, p_damage, 0)):
         if cost < min_cost:
            min_cost = cost
      ...
      for a in armor:
         ...
         cost = w[0] + a[0]
         p_armor = a[2]
         if isWin(e_attr, (p_hp, p_damage, p_armor)):
            if cost < min_cost:
               min_cost = cost
   ...
   # Display the minimum cost of a win
   print('Minimum cost of a win = ' + str(min_cost))
